...
{
    [SerializeField]
    private UnitSpringSettings m_Settings;
    ...
    public UnitSpringSettings.Data Data => m_CurrentData;
    ...
    [SerializeField]
    private UnitSpringSettings.Data m_CurrentData;
    ...
    private void Awake()
    {
        ...
        m_CurrentData = new UnitSpringSettings.Data(m_Settings.data[m_Unit.BodyState]);
    }
    ...
    {
        float t = 0.0f;
        UnitSpringSettings.Data previousData = new UnitSpringSettings.Data(m_CurrentData);
        UnitSpringSettings.Data targetData = m_Settings.data[state];
        while (t != 1.0f)
        {
            ...
            m_CurrentData.slipAngle = Mathf.Lerp(previousData.slipAngle, targetData.slipAngle, t);
